...
pkgdatadir = $(datadir)/funca-program
pkgincludedir = $(includedir)/funca-program
pkglibdir = $(libdir)/funca-program
pkglibexecdir = $(libexecdir)/funca-program
...
am_funca_program_OBJECTS = funca_program-main.$(OBJEXT) \
	funca_program-funca.$(OBJEXT) \
	funca_program-HTTP_Server.$(OBJEXT)
funca_program_OBJECTS = $(am_funca_program_OBJECTS)
...
am__depfiles_remade = ./$(DEPDIR)/funca.Po \
	./$(DEPDIR)/funca_program-HTTP_Server.Po \
...
OBJEXT = o
PACKAGE = funca-program
PACKAGE_BUGREPORT = kovalvlada0910@gmail.com
PACKAGE_NAME = FuncA Program
PACKAGE_STRING = FuncA Program 1.0
PACKAGE_TARNAME = funca-program
PACKAGE_URL = 
PACKAGE_VERSION = 1.0
PATH_SEPARATOR = :
SET_MAKE = 
...
funca_program_SOURCES = main.cpp funca.cpp funca.h HTTP_Server.cpp HTTP_Server.h
...
include ./$(DEPDIR)/funca_program-HTTP_Server.Po # am--include-marker
...
funca_program-HTTP_Server.o: HTTP_Server.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(funca_program_CXXFLAGS) $(CXXFLAGS) -MT funca_program-HTTP_Server.o -MD -MP -MF $(DEPDIR)/funca_program-HTTP_Server.Tpo -c -o funca_program-HTTP_Server.o `test -f 'HTTP_Server.cpp' || echo '$(srcdir)/'`HTTP_Server.cpp
	$(AM_V_at)$(am__mv) $(DEPDIR)/funca_program-HTTP_Server.Tpo $(DEPDIR)/funca_program-HTTP_Server.Po
#	$(AM_V_CXX)source='HTTP_Server.cpp' object='funca_program-HTTP_Server.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(funca_program_CXXFLAGS) $(CXXFLAGS) -c -o funca_program-HTTP_Server.o `test -f 'HTTP_Server.cpp' || echo '$(srcdir)/'`HTTP_Server.cpp

funca_program-HTTP_Server.obj: HTTP_Server.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(funca_program_CXXFLAGS) $(CXXFLAGS) -MT funca_program-HTTP_Server.obj -MD -MP -MF $(DEPDIR)/funca_program-HTTP_Server.Tpo -c -o funca_program-HTTP_Server.obj `if test -f 'HTTP_Server.cpp'; then $(CYGPATH_W) 'HTTP_Server.cpp'; else $(CYGPATH_W) '$(srcdir)/HTTP_Server.cpp'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/funca_program-HTTP_Server.Tpo $(DEPDIR)/funca_program-HTTP_Server.Po
#	$(AM_V_CXX)source='HTTP_Server.cpp' object='funca_program-HTTP_Server.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(funca_program_CXXFLAGS) $(CXXFLAGS) -c -o funca_program-HTTP_Server.obj `if test -f 'HTTP_Server.cpp'; then $(CYGPATH_W) 'HTTP_Server.cpp'; else $(CYGPATH_W) '$(srcdir)/HTTP_Server.cpp'; fi`
...
distclean: distclean-am
	...
	-rm -f ./$(DEPDIR)/funca_program-HTTP_Server.Po
